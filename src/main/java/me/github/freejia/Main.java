...
public class Main extends JavaPlugin {
    ...
    public void init() {
        ...
        config.getConfig().addDefault("cash_shop_message.buy_sound", Sound.ENTITY_ARROW_HIT_PLAYER.name());
        config.getConfig().addDefault("cash_shop_message.sell_sound", Sound.ENTITY_ARROW_HIT_PLAYER.name());
